...
return [
    ...
    */
    'cas_hostname'        => env('CAS_HOSTNAME', 'auth.univ-lorraine.fr'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'auth.univ-lorraine.fr/logout'),
    ...
    */
    'cas_logout_redirect' => env('CAS_LOGOUT_REDIRECT', 'http://polytech-international.univ-lorraine.fr:8000/test'),
    ...
    */
    'cas_redirect_path'   => env('CAS_REDIRECT_PATH', 'http://polytech-international.univ-lorraine.fr:8000/test'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_debug'           => env('CAS_DEBUG', '/home/fred/github/PIVE-Site-Web-International'),
